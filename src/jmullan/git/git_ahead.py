...
class GitAheadMain(cmd.Main):
    def __init__(self):
        ...
        group.add_argument("to_rev", default=UPSTREAM, help="How far ahead of this branch?")

        group.add_argument("from_rev", nargs="?", default=HEAD, help="How far is this branch ahead?")
