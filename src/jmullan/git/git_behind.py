...
def git_behind(from_rev: str, to_rev: str):
    return count_commits(from_rev, to_rev).behind


class GitBehindMain(cmd.Main):
    def __init__(self):
        super().__init__()
    ...
    def main(self):
        ...
        if self.args.to_rev in (WORKING_TREE, STAGED):
            ...
            exit(1)
        print(git_behind(self.args.from_rev, self.args.to_rev))
